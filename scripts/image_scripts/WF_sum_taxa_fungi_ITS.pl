...
$def_loc = "03_taxa_class/its.rep.taxa.txt";
$fasta_loc = "02_its/its.rep.fasta";
$aln_loc = "03_taxa_class/its.rep.UNITE.txt";

if(! -f $def_loc || ! -f $fasta_loc || ! -f $aln_loc){
	print "[FATAL] Could not find complete ITS files ...\n";
	exit;
}

print "[Taxonomy Class. Summary - ITS]\n";
