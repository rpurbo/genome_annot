...
$def_loc = "03_taxa_class/18S_rrna.rep.taxa.txt";
$fasta_loc = "02_rrna/18S_rrna.rep.fasta";
$aln_loc = "03_taxa_class/18S_rrna.rep.SILVA.txt";
...
print "[Taxonomy Class. Summary - 18S]\n";
...
print "#18S rRNA Sequence(s)," . $rrna_num . "\n";
print "Isolate," . $MIX . "\n";
